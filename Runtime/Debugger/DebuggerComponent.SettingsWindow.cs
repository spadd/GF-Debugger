...
namespace GF.Runtime
{
    public sealed partial class DebuggerComponent : GameFrameworkComponent
    {
        public sealed class SettingsWindow : ScrollableDebuggerWindowBase
        {
            ...
            {
                float value = PlayerPrefs.GetFloat(Application.productName + "_" + key, defaultValue);
            ...
            {
                PlayerPrefs.SetFloat(Application.productName + "_" + key, value);
            }
            ...
            public override void Initialize(params object[] args)
            {
                ...
                m_LastWindowX = GetFloat("Debugger.Window.X", DefaultWindowRect.x);
                m_LastWindowY = GetFloat("Debugger.Window.Y", DefaultWindowRect.y);
                m_LastWindowWidth = GetFloat("Debugger.Window.Width", DefaultWindowRect.width);
                m_LastWindowHeight = GetFloat("Debugger.Window.Height", DefaultWindowRect.height);
                m_DebuggerComponent.WindowScale = m_LastWindowScale = GetFloat("Debugger.Window.Scale", DefaultWindowScale);
