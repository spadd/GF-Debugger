...
namespace GF.Runtime
{
    public sealed partial class DebuggerComponent : GameFrameworkComponent
    {
        ...
        private sealed class ConsoleWindow : IDebuggerWindow
        {
            ...
            {
                int value = PlayerPrefs.GetInt(Application.productName + "_" + key, (defaultValue == false ? 0 : 1));
            ...
            {
                PlayerPrefs.SetInt(Application.productName + "_" + key, (value == true ? 1 : 0));
            }

            public void Initialize(params object[] args)
            {
                Application.logMessageReceived += OnLogMessageReceived;
                m_LockScroll = m_LastLockScroll = GetBool("Debugger.Console.LockScroll", true);
                m_InfoFilter = m_LastInfoFilter = GetBool("Debugger.Console.InfoFilter", true);
                m_WarningFilter = m_LastWarningFilter = GetBool("Debugger.Console.WarningFilter", true);
                m_ErrorFilter = m_LastErrorFilter = GetBool("Debugger.Console.ErrorFilter", true);
                m_FatalFilter = m_LastFatalFilter = GetBool("Debugger.Console.FatalFilter", true);
            }
